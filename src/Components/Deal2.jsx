...
function Deal2() {
  return (
    <div className='w-[333px] h-[425] bg-white rounded-xl p-[20px]'>
          ...
          <div className='w-[292px] h-[48px] bg-[#1B88F4] rounded-xl text-white text-[16px] flex items-center justify-center'>View Deal</div>
        </div>
  )
}
